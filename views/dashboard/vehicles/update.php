        ...
        <form action="" method="POST" class="form" novalidate>
            <div class="row">
                ...
                <div class="col col-md-6">
                    ...
                    type="text" 
                    class="form-control" 
                    placeholder="<?= $vehicle->brand ?? $vehicleBrand ?>" 
                    id="vehicleBrand" 
                    required>
                ...
                <div class="col col-md-6">
                    ...
                    type="text" 
                    class="form-control" 
                    placeholder="<?= $vehicle->model ?? $vehicleModel ?>" 
                    id="vehicleModel" 
                    required>
            ...
            <div class="row">
                ...
                <div class="col col-md-6">
                    ...
                    type="text" 
                    class="form-control" 
                    placeholder="<?= $vehicle->registration ?? $vehicleRegistration ?>" 
                ...
                <div class="col col-md-6">
                    ...
                    type="number" 
                    class="form-control" 
                    placeholder="<?= $vehicle->mileage ?? $vehicleMileage ?>" 
                    id="vehicleMileage" 
                    required>
            ...
            <div class="row">
                ...
                <div class="col col-md-6">
                    ...
                    aria-label="Floating label select example">
                        <option value="<?= $vehicle->id_category ?? '' ?>" 
                        class="listNames" 
                        disabled 
                        selected 
                        hidden><?=$category->name ?? 'séléctionnez une catégorie' ?></option>
