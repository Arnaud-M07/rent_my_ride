                ...
                <tbody>
                    ...
                    foreach ($vehicles as $vehicle) { ?>
                        <tr>
                            ...
                            <td><a class='btn btn-dark btn-modify' href='/controllers/dashboard/vehicles/update-ctrl.php?id_vehicle=<?= $vehicle->id_vehicle ?>'><i class='bi bi-pencil-square'></i></a></td>
                            <td><a class='btn btn-dark btn-delete' onclick="return confirm('Voulez-vous vraiment supprimer cet enregistrement ?')" href='/controllers/dashboard/vehicles/delete-ctrl.php?id_vehicle=<?= $vehicle->id_vehicle ?>'><i class='bi bi-trash'></i></a></td>
                        </tr>
                    <?php }
                    ?>
                </tbody>
